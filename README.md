...
- 可视化管理：内置 Web 管理面板（参考 [lumgr](https://github.com/hnrobert/lumgr)），浏览器里即可增删改仓库规则、飞书机器人、事件、模板等，无需手改 YAML
...
- [x] 已添加基于 `html/template` 的 `web` 管理面板（参考 [lumgr](https://github.com/hnrobert/lumgr) 风格，白色 + `#4EACF8`/`#071C37` 主题，中英双语），可在浏览器中查看日志 / 修改仓库规则、飞书机器人、服务设置、事件与消息模板。详见 [QUICKSTART.md](QUICKSTART.md#3-web-管理面板可选--optional)。
